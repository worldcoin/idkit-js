...
const PrivacyState = () => {
	return (
		<div className="-mt-6 flex flex-col items-center justify-center space-y-6 font-sans">
			...
			<ul className="text-9eafc0 mb-6 list-disc space-y-3 px-4">
				...
				<li className="text-left dark:text-white">Orb biometrics analyzed by the Orb are not stored.</li>
				<li className="text-left dark:text-white">
			...
			<div className="text-9eafc0 -ml-4 flex items-center space-x-3 dark:text-white">
