...
const IDKitWidget: FC<WidgetProps> = ({ children, actionId, signal, onVerification, onSuccess, autoClose, copy }) => {
	const { isOpen, onOpenChange, processing, stage, setStage, setOptions, copy: _copy } = useIDKitStore(getParams)
	const [isMobile, setIsMobile] = useState(false)

	useEffect(() => {
		setOptions({ actionId, signal, onSuccess, onVerification, autoClose, copy }, ConfigSource.PROPS)
	}, [actionId, signal, onSuccess, onVerification, autoClose, copy, setOptions])
