...
__export(src_exports, {
  ...
  buffer_encode: () => buffer_encode,
  decryptResponse: () => decryptResponse,
  encryptRequest: () => encryptRequest,
  exportKey: () => exportKey,
  generateKey: () => generateKey,
  getCrypto: () => getCrypto,
  getTextEncoderDecoder: () => getTextEncoderDecoder,
  hashToField: () => hashToField,
  packAndEncode: () => packAndEncode,
  setupIDKitForReactNative: () => setupIDKitForReactNative,
...
var buffer_encode = (buffer) => {
  return import_buffer.Buffer.from(buffer).toString("base64");
};
var buffer_decode = (encoded) => {
  return import_buffer.Buffer.from(encoded, "base64").buffer;
};

// src/adapters/hash.ts
var import_js_sha3 = require("js-sha3");
var keccak256 = import_js_sha3.keccak256 || function(input) {
