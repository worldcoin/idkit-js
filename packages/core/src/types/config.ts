...
export type IDKitConfig = {
	...
	partner?: boolean
	/**
	 * When true, the authenticator requires Face Authentication before issuing a proof for this request.
	 * If Face Authentication fails or is not performed, no proof will be generated by the authenticator.
	 * Receiving a proof implies Face Authentication succeeded for this request.
	 */
	face_auth?: boolean
}
